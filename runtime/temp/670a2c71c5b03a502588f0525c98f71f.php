<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/notice\edit.html";i:1511771338;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">通知标题<span class="check-tips">言简意赅</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="name" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">通知内容<span class="check-tips">请走文艺范儿</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="content" value="<?php echo (isset($info['tel']) && ($info['tel'] !== '')?$info['tel']:''); ?>">
        </div>
    </div>
    <div class="form-item">
